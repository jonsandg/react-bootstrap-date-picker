...
var CalendarHeader = (0, _createReactClass2.default)({
  ...
  propTypes: {
    ...
    quickYearChange: _propTypes2.default.bool
  },
  ...
  render: function render() {
    ...
    if (this.props.quickYearChange) {
      ...
      var yearOptions = [];
      for (var i = startYear.getFullYear(); i <= endYear.getFullYear(); i++) {
...
exports.default = (0, _createReactClass2.default)({
  ...
  makeDateValues: function makeDateValues(isoString) {
    ...
    var minDate = this.props.minDate ? new Date(this.props.minDate) : null;
    var maxDate = this.props.maxDate ? new Date(this.props.maxDate) : null;
